...
public class PjshiftAdapter extends RecyclerView.Adapter<PjshiftAdapter.PjViewHolder> {

    private List<Pjshift> pjshift;
    private Context context;

    public PjshiftAdapter(List<Pjshift> pjshift, Context context) {
    ...
    public void onBindViewHolder(PjViewHolder pjshiftViewHolder, int i) {
        pjshiftViewHolder.name_tv.setText(pjshift.get(i).getNama());
        pjshiftViewHolder.shift_tv.setText(pjshift.get(i).getShift());
        pjshiftViewHolder.nohp_tv.setText(pjshift.get(i).getNohp());
        pjshiftViewHolder.pic_iv.setImageResource(pjshift.get(i).getPhotoID());
    ...
    public PjViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_pjshift, viewGroup, false);
